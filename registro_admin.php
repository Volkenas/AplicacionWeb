...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body style="zoom: 1;">
                    ...
                    <form method="POST" action="operaciones/newregistro.php" name="newestudent" onsubmit="return longitudreg();">
                        <td>
                            ...
                            <label>Cedula:</label>
                                ...
                                <input type="text" name="cedula" id="cedula" maxlength="10" value="" onkeypress="return validar(event, 'num');" required /><br><br><br>
    ...
    var ValidarPassword = new LiveValidation('pass');
    ValidarPassword.add(Validate.Presence);
