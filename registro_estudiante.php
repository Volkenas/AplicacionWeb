...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body style="zoom: 1;">
    ...
    <!-- Wrap the rest of the page in another container to center all the content. -->
     ...
     <h2 align="center"> Registro de Estudiante </h2></br>
                    ...
                    <td>
                        <form method="POST" action="operaciones/newregistro.php" name="newestudent" onsubmit="return longitudreg();">
                            ...
                            <label>Cedula:</label>
                                ...
                                </select><input type="text" name="cedula" id="cedula" maxlength="8" value="" onkeypress="return validar(event, 'num');" required /><br><br>

                            <label>Sexo:</label>

                                <input type="radio" name="sexo" id="sexo_m" value="Hombre" checked />Masculino
                                <input type="radio" name="sexo" id="sexo_f" value="Mujer" />Femenino<br><br>
                            ...
                            <label>Trimestre:</label>
                               <select name="trimestre">
                                ...
                                <input type="hidden" name="nivel" value="Estudiante">
    ...
    <!-- Validaciones JS-->
    <script>
    var ValidarNombre = new LiveValidation('nombres');
    ValidarNombre.add(Validate.Presence);
    
    var ValidarApellido = new LiveValidation('apellidos');
    ValidarApellido.add(Validate.Presence);    
